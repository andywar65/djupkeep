...
urlpatterns = [
    ...
    path(
        ...
        TaskCalendarRefreshView.as_view(),
        name="task_calendar_refresh",
    ),
    path(
        "task/add/",
    ...
    path(
        "task/bulk/update/",
        TaskBulkUpdateView.as_view(),
        name="task_bulk_update",
    ),
    path(
        "task/bulk/button/",
        TaskBulkButtonView.as_view(),
        name="task_bulk_button",
    ),
    path(
        "task/add/",
        TaskCreateView.as_view(),
